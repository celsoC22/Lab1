...
import ENUM.TransactionTypes;
import TRANSACTION.SUBCLASS.*;
...
public class TransactionProcessing {
    ...
    public static TransactionProcessing init() {
        ...
        //Add ACCOUNT.Account Credit - generating 2 random objects
        countdown = 2;
        while (countdown > 0) {
    ...
    public static void listTransactionsByType(TransactionProcessing tp, TransactionTypes type) {
        switch (type) {
            ...
            default: {
                throw new IllegalArgumentException("Unable to handle request " + type);
